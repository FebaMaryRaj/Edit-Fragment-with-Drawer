...
public class EditFragment extends Fragment {
    ...
    DummyContent.DummyItem dummyDataItem;
    ...
    public EditFragment(DummyContent.DummyItem item) {
        dummyDataItem = item;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        titleET.setText(dummyDataItem.content);
        detailsET.setText(dummyDataItem.details);
    ...
    private void saveButtonClicked(View view) {
        dummyDataItem.content = titleET.getText().toString();
        dummyDataItem.details = detailsET.getText().toString();
        if (mListener != null) {
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onFragmentInteraction(boolean refreshRequested);
    }
}
